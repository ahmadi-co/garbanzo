        ...
        <div className="transfer-wrapper">
          ...
          <div className="transfer-content-left">
            <div className="transfer-brand">
              <span className="transfer-brand-crypto">crypto</span>
              <span className="transfer-brand-master">master</span>
            </div>
            <h1 className="transfer-main-headline">
              {slide.mainHeadline.split(slide.highlightWord).map((part, index, array) => (
      ...
      <div className={`hero-slide hero-slide-atm ${isActive ? 'active' : ''}`}>
        <div className="atm-wrapper">
          ...
          <div className="atm-content-right">
            {/* 
              ============================================
              ATM MACHINE IMAGE PLACEHOLDER
              ============================================
              Replace the div below with your ATM image:
              
              <div className="atm-machine-placeholder">
                <img src="/images/atm-machine.png" alt="ATM Machine" className="atm-machine-image" />
              </div>
              
              Or if image is in src folder:
              <div className="atm-machine-placeholder">
                <img src={require('./path-to-image.png')} alt="ATM Machine" className="atm-machine-image" />
              </div>
            */}
            {/*<div className="atm-machine-placeholder">*/}
            {/*  <div className="atm-placeholder-text">*/}
            {/*    <p>ATM Image Placeholder</p>*/}
            {/*    <p className="atm-placeholder-hint">Insert your ATM machine image here</p>*/}
            {/*  </div>*/}
            {/*</div>*/}

              <div className="atm-machine-placeholder">
                  <img src={require('../../../assets/hero-section/atm-cash-dispenser.jpg')} alt="ATM Machine" className="atm-machine-image" />
              </div>
            ...
            {slide.infoBox1 && (
              <div className="atm-info-box atm-info-box-top">
                {slide.infoBox1.icon === 'play' && (
                  <svg className="atm-play-icon" width="20" height="20" viewBox="0 0 24 24" fill="#00ffff">
